...
# IMPROVEMENT 1: smoother display
# How many times per second the terminal map refreshes.
# Raised from 2 to 4 so the robot marker and status bar feel more responsive.
UI_REFRESH_HZ = 4
...
# IMPROVEMENT 1: smoother map data
# How often the map is copied from the SLAM process (times per second).
# Raised from 1.0 to 2.0 so wall changes appear on screen twice as fast.
MAP_UPDATE_HZ = 2.0
...
# ===========================================================================
# IMPROVEMENT 2 & 3: path tracking settings
# ===========================================================================

# Maximum number of (x, y) waypoints stored in the path ring buffer.
# At PATH_MIN_DIST_MM = 50 mm between points and typical exploration speeds
# this covers several hundred metres of travel before old points are dropped.
MAX_PATH_POINTS = 2000

# Minimum distance (mm) the robot must move before a new path point is saved.
# Prevents the buffer from filling up while the robot is stationary or
# rotating in place.
